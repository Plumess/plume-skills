...
1. Use the Read tool to read: `PLUME_ROOT/vendor/superpowers/test-driven-development/SKILL.md` (replace PLUME_ROOT with the path from `[PLUME_ROOT: ...]` in your session context)
