...
1. Use the Read tool to read: `PLUME_ROOT/vendor/superpowers/requesting-code-review/SKILL.md` (replace PLUME_ROOT with the path from `[PLUME_ROOT: ...]` in your session context)
